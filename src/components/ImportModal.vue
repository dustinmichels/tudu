...
const providers: ProviderOption[] = [
	...
	},
	{
		id: "todoist",
		name: "Todoist",
		description: "Direct sync and project import from Todoist API or CSV/JSON export.",
		enabled: false,
		badge: "Coming soon",
	},
];
...
async function processFile(file: File) {
	...
	try {
		...
		errorMessage.value =
			err instanceof Error ? err.message : "Failed to import tasks. Please check the JSON format.";
	} finally {
	...
	>
		...
		>
			...
			<div class="p-5 space-y-4 overflow-y-auto">
				<div>
					<label
						class="block text-xs font-semibold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-2"
					>
						Select Provider
					</label>
					<div class="space-y-2">
			...
			<!-- Footer -->
			<div
				class="px-5 py-3 border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 flex items-center justify-end gap-2"
			>
				<button
					type="button"
					@click="closeModal"
